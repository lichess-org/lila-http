...
then [lila](https://github.com/lichess-org/lila) has to serve about 5k tournament update requests
per second.
...
Much like [lila-ws](https://github.com/lichess-org/lila-ws) moved the websocket traffic away from lila,
